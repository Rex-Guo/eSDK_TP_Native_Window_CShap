...
{
    public partial class SetContinuousPresence : Form
    {
        ...
        private void OK_Button_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.lb_SiteURI.Items.Count != 0 && this.tb_confID.Text != "")
                {
                    ...
                    this.target = this.textBox1.ToString();
                    this.presenceMode = Convert.ToInt32(this.comboBox1.Text.ToString());
